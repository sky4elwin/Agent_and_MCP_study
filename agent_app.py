...
# ============================================================
REACT_SYSTEM_PROMPT = """你是一个智能助手，可以查询天气和股票信息。你必须严格按照以下格式思考和回复：
    ...
    try:
        ...
        async with stdio_client(mcp_server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                print("初始化完成！")
                print("输入城市名查天气，或输入股票代码查股票信息（输入 'quit' 退出）")
                print("  示例: 北京 / Tokyo / AAPL / 000300.SS / 0700.HK")
                ...
                while True:
                    try:
                        ...
                        result = await agent.ainvoke({
                            "messages": [("user", f"请帮我查询: {user_input}。如果是城市名就查天气，如果是股票代码就查股票信息。")]
                        })
